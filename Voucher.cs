...
namespace RevenueMonsterOpenAPI
{
    public class Voucher
    {
        ...
        public async Task<VoidVoucherResult> VoidVoucher(string code, string privateKey, string accessToken, string environment)
        {
            Object data = new { };
            string compactJson = SignatureUtil.GenerateCompactJson(data);
            string encode = Encode.Base64Encode(compactJson);
        ...
        public async Task<GetVoucherByCodeResult> GetVoucherByCode(string code, string privateKey, string accessToken, string environment)
        {
            string method = "get";
            string nonceStr = RandomString.GenerateRandomString(32);
            string requestUrl = "";
        ...
        public async Task<GetVoucherBatchesResult> GetVoucherBatches(string privateKey, string accessToken, string environment)
        {
            string method = "get";
            string nonceStr = RandomString.GenerateRandomString(32);
            string requestUrl = "";
        ...
        public async Task<GetVoucherBatchByKeyResult> GetVoucherBatchByKey(string batchKey, string privateKey, string accessToken, string environment)
        {
            string method = "get";
            string nonceStr = RandomString.GenerateRandomString(32);
            string requestUrl = "";
