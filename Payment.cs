...
namespace RevenueMonsterOpenAPI
{
    public class Payment
    {
        ...
        public async Task<QuickPay> QuickPay(Object data, string privateKey, string accessToken, string environment)
        {
            string compactJson = SignatureUtil.GenerateCompactJson(data);
            string method = "post";
            string nonceStr = RandomString.GenerateRandomString(32);
        ...
        public async Task<Refund> Refund(Object data, string privateKey, string accessToken, string environment)
        {
            string compactJson = SignatureUtil.GenerateCompactJson(data);
            string method = "post";
            string nonceStr = RandomString.GenerateRandomString(32);
        ...
        public async Task<PaymentTransactionByID> GetPaymentTransactionByID(string transactionId, string privateKey, string accessToken, string environment)
        {
            string method = "get";
            string nonceStr = RandomString.GenerateRandomString(32);
            string requestUrl = "";
        ...
        public async Task<PaymentTransactionByOrderID> GetPaymentTransactionByOrderID(string orderId, string privateKey, string accessToken, string environment)
        {
            string method = "get";
            string nonceStr = RandomString.GenerateRandomString(32);
            string requestUrl = "";
        ...
        public async Task<CreateTransactionQrCodeUrl> CreateTransactionQRCodeUrl(Object data, string privateKey, string accessToken, string environment)
        {
            string compactJson = SignatureUtil.GenerateCompactJson(data);
            string method = "post";
            string nonceStr = RandomString.GenerateRandomString(32);
        ...
        public async Task<GetTransactionQrCodeUrl> GetTransactionQrCodeUrl(string limit, string type, string expiryType, string privateKey, string accessToken, string environment)
        {
            string method = "get";
            string nonceStr = RandomString.GenerateRandomString(32);
            string requestUrlEncode = "";
            ...
            Signature signature = new Signature();
            string signatureResult = "";
            signatureResult = signature.GenerateSignature("", method, nonceStr, privateKey, requestUrlEncode, signType, timestamp, environment);
            signatureResult = "sha256 " + signatureResult;
            GetTransactionQrCodeUrl result = new GetTransactionQrCodeUrl();
            try
            {
        ...
        public async Task<GetTransactionQrCodeUrlByCode> GetTransactionQrCodeUrlByCode(string qrCode, string privateKey, string accessToken, string environment)
        {
            string method = "get";
            string nonceStr = RandomString.GenerateRandomString(32);
            string requestUrl = "";
        ...
        public async Task<GetTransactionsByCode> GetTransactionsByCode(string qrCode, string privateKey, string accessToken, string environment)
        {
            string method = "get";
            string nonceStr = RandomString.GenerateRandomString(32);
            string requestUrl = "";
