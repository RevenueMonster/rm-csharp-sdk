...
namespace RevenueMonsterOpenAPI
{
    public class Loyalty
    {
        ...
        public async Task<GetLoyaltyMembersResult> GetLoyaltyMembers(string privateKey, string accessToken, string environment)
        {
            string method = "get";
            string nonceStr = RandomString.GenerateRandomString(32);
            string requestUrl = "";
        ...
        public async Task<GetLoyaltyMemberResult> GetLoyaltyMember(string memberId, string privateKey, string accessToken, string environment)
        {
            string method = "get";
            string nonceStr = RandomString.GenerateRandomString(32);
            string requestUrl = "";
        ...
        public async Task<LoyaltyMemberPointHistories> GetLoyaltyMemberPointHistory(string memberId, string privateKey, string accessToken, string environment)
        {
            string method = "get";
            string nonceStr = RandomString.GenerateRandomString(32);
            string requestUrl = "";
